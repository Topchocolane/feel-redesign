            ...
            <div className="lg:col-span-7 lg:col-start-6">
              ...
              <div className="mt-10 grid gap-8 sm:grid-cols-2">
                <div className="border-l-2 border-orange pl-6">
                  <p className="text-3xl font-extrabold tracking-widest text-ink">
                    專注
                  </p>
          ...
          <div className="grid grid-cols-1 gap-px bg-line md:grid-cols-2 lg:grid-cols-3">
            {SERVICES.map((s) => (
              ...
              >
                ...
                {/* Title */}
                <h3 className="mt-12 text-2xl font-extrabold tracking-widest text-ink group-hover:text-orange transition-colors">
                  {s.title}
                </h3>
